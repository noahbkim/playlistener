...
urlpatterns = [
    ...
    path("twitch/<int:pk>/update/", views.TwitchIntegrationUpdateView.as_view(), name="twitch_integration_update"),
    path("twitch/<int:pk>/delete/", views.TwitchIntegrationDeleteView.as_view(), name="twitch_integration_delete"),
